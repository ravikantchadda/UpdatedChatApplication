...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (chatDialog.type) {
        case QBChatDialogTypePrivate: {
            ...
            [[ServicesManager instance].chatService.chatAttachmentService getProfileImageForUsers:[@(recipient.blobID) stringValue] completion:^(NSError *error, UIImage *image) {
